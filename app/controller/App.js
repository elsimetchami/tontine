 ...
 */
Ext.define('Compare.controller.App', {
        ...
        switch( token ) {
            case 'option/make':
                config = {
                    ...
                    iconCls: 'icon_make',
                    store: Ext.create( 'Compare.store.option.Makes', {
                        pageSize: 30
                    })
                };
                break;
            case 'option/model':
                config = {
                    ...
                    iconCls: 'icon_model',
                    store: Ext.create( 'Compare.store.option.Models', {
                        pageSize: 30
                    }),
                    extraColumns: {
                        text: 'Make',
            ...
            case 'option/category':
                config = {
                    ...
                    store: Ext.create( 'Compare.store.option.Categories', {
                        pageSize: 30
                    })
                };
                break;
            case 'option/color':
                config = {
                    ...
                    iconCls: 'icon_color',
                    store: Ext.create( 'Compare.store.option.Colors', {
                        pageSize: 30
                    })
                };
                break;
            case 'option/feature':
                config = {
                    ...
                    store: Ext.create( 'Compare.store.option.Features', {
                        pageSize: 30
                    })
                };
                break;
            case 'option/position':
                config = {
                    ...
                    store: Ext.create( 'Compare.store.option.Positions', {
                        pageSize: 30
                    })
                };
                break;
            case 'option/status':
                config = {
                    ...
                    iconCls: 'icon_status',
                    store: Ext.create( 'Compare.store.option.Statuses', {
                        pageSize: 30
                    })
                };
                break;
            ...
            case 'inventory':
                ...
                break;
                //commencer mon application// start application
                // reunion//
                case 'reunion':
                config = {
                    xtype: 'reunion.list'
                ...
                break;
                   // personne//
                case 'periode_reunion':
                    config = {
                        xtype: 'periode_reunion.list'
                    };
                break;
                // categorie//
                case 'categorie':
                    config = {
                        xtype: 'categorie.list'
                    };
                break;
              // detail_categorie//
              case 'detail_categorie':
                ...
                case 'aide/parametre':
                    config = {
                        xtype: 'aide.parametre.list'
                    };
                break;
                // Aide/suivi_aide
                case 'aide/suivi_aide':
                    config = {
                        xtype: 'aide.suivi_aide.suivi_aide'
                    };
                break;
                // Aide/suivi_aide
                // case 'aide/suivi_aide':
                ...
                //  pret/parametre
                 case 'pret/parametre':
                    config = {
                        xtype: 'pret.parametre.list'
                    };
                break;
                case 'pret/suivi_pret':
                    config = {
                        xtype: 'pret.suivi_pret.suivi_pret'
                    };
                break;
                // dashboard
                case 'dashboard/atelier':
                    config = {
                        xtype: 'dashboard.atelier.dashboard',
                        title: 'Manage atelier',
                        iconCls: 'icon_feature',
                        store: Ext.create( 'Compare.store.dashboard.Atelier', {
                            pageSize: 30
                        })
                    };
                    break;
                    case 'dashboard/frontiere':
                    config = {
                        xtype: 'dashboard.frontiere.dashboard',
                        title: 'Manage frontiere',
                        iconCls: 'icon_feature',
                        store: Ext.create( 'Compare.store.dashboard.Frontiere', {
                            pageSize: 30
                        })
                    };
                    break;
                    case 'dashboard/pose':
                        config = {
                            ...
                            title: 'Manage Pose',
                            iconCls: 'icon_feature',
                            store: Ext.create( 'Compare.store.dashboard.Pose', {
                                pageSize: 30
                            })
                        };
                        break;
     ...
     * @param {Compare.proxy.Rest} proxy
     * @param {Array} data
